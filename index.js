...
if (!(options && apiKey && zone && releaseGroup && puckName)) {
  console.log("usage: node index.js -a <api key> -z <zone id> -r <release group id> -p <puck name>");
  process.exit(1);
}

// connect to a puck. When connected it will emit a connected event.
var puck = new Puck(puckName);
